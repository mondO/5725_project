...
// this code reads all the hardware and print it on the screen
...
int main(int argc, char **argv)
{
    ...
    /*bcm2835_aux_spi_setBitOrder(BCM2835_SPI_BIT_ORDER_MSBFIRST);      // The default*/
    /*bcm2835_aux_spi_setDataMode(BCM2835_SPI_MODE0);                   // The default*/
    bcm2835_aux_spi_setClockDivider(BCM2835_SPI_CLOCK_DIVIDER_64); 	  // 4MHz clock with _64 
    /*bcm2835_aux_spi_chipSelect(BCM2835_SPI_CS0);                      // The default*/
    /*bcm2835_aux_spi_setChipSelectPolarity(BCM2835_SPI_CS0, LOW);      // the default*/
	...
	{
        //read 8 bits ADC
        bcm2835_aux_spi_transfernb(buf,readBuf,3);
        input_signal =  ((int)readBuf[1] & 0x03) << 8 | (int) readBuf[2];

        //read 12 bits ADC
        /*bcm2835_spi_transfernb(mosi, miso, 3);*/
        /*input_signal = miso[2] + ((miso[1] & 0x0F) << 8); */
    
        //Read the hardware and print it later
        ...
        printf ("PUSH1 = %d, PUSH2 = %d, TOGGLE_SWITCH = %d, FOOT_SWITCH = %d , ADC = %d \n",PUSH1_val, PUSH2_val, TOGGLE_SWITCH_val, FOOT_SWITCH_val, input_signal);
